...
with open('option.csv', 'a') as csvfile:
    fieldnames = ['Expiry','Last','Change','Bid','Ask','Vol','Open Interest']
    ...
    for row in calltable.findAll('tr')[1:]:
        ...
        writer.writerow({'Expiry': expiry,'Last': last,'Change': chg,'Bid': bid,'Ask': ask,'Vol': vol,'Open Interest': openInt})
